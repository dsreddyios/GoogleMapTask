...
//  SentientMapsTask
//
//  Created by John Prakash on 14/04/21.
    import UIKit
    import GoogleMaps
    import GooglePlaces
    import Alamofire
    ...
    var mapAddress = [LocationStore]()
    protocol LocateOnTheMap {
        func locateWithLong(lon: String, andLatitude lat: String, andAddress address: String)
    }
    class LocSearchVC: UIViewController, UISearchBarDelegate, UITableViewDelegate, UITableViewDataSource, UISearchControllerDelegate {
                ...
                .responseJSON { [self] (response) in
                    ...
                    case.success(let value):
                        ...
                        if searchController.isActive{
                            mapAddress.append(LocationStore(Location: g_address))
    ...
    extension LocSearchVC: UISearchResultsUpdating {
